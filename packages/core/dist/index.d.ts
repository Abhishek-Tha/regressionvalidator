...
export type { BlockGuardConfig, SiteConfig, ViewportConfig, BlockDetectionConfig, DiscoveryConfig, SelectionConfig, CaptureConfig, ThresholdsConfig, } from './config/schema.js';
...
export type { BlockUsage, BlockSignature, IndexedPage, UsageIndex, BlockUsageSummary, } from './indexing/types.js';
...
export type { PageComparisonResult, RegressionReport, ReportSummary, PageStatus, } from './reporting/types.js';
