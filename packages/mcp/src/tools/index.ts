export const toolDefinitions = [
  {
    ...
    description:
      'Discover all pages on an EDS site and build a block-usage index. Use this before querying block usage.',
    inputSchema: {
      type: 'object',
      properties: {
        baseUrl: {
  ...
  },
  {
    ...
    description:
      'Run a full regression test for one or more blocks: screenshot live + preview, pixel diff, DOM diff, accessibility, and runtime checks.',
    inputSchema: {
      type: 'object',
      properties: {
        block: {
